  ...
  return (
    ...
    <div className="container">
        <div className="contact-left row">
          <div className="col-lg-4">
            <div className="card p-3">
              <a
                ...
                href="https://wa.me/2349071252345"
                target="_blank"
          ...
          <div className="col-lg-4">
            <div className="card p-3">
              <a
                ...
                href="mailto:faridaabdulsalam966@gmail.com?subject=hello&body=I%20would%20contact%20you"
              >
                SEND AN EMAIL
              </a>
            </div>
          ...
          <div className="col-lg-4">
            <div className="card p-3">
              <a className="btn btn-lg btn-success" href="tel:+2349071252345">
                CALL
              </a>
            </div>
          </div>
